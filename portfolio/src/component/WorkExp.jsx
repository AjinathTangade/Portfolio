    ...
    return (
        <>
            <div className="min-h-screen px-5 mb-24 lg:mx-auto lg:max-w-5xl lg:h-[650px] lg:py-5 sm:px-6 sm:block">
                <h4 className='text-2xl before:w-[220px] before:absolute before:border before:border-[#233554] before:top-4 before:right-0 lg:text-3xl lg:w-4/5 font-bold leading-8 text-indigo-100 relative lg:before:absolute lg:before:w-[420px] lg:before:rounded-md lg:before:border lg:before:border-[#233554] lg:before:right-0 lg:before:top-4'> <span className='text-emerald-300 text-2xl font-semibold pb-4 pr-3 md:text-2xl'>02.</span>Where I’ve Worked</h4>
                <div className="flex flex-col py-8 ">
                    <Tabs className="-mx-3 space-y-14 space-x-10 flex border-l-2 border-[#233554]">
